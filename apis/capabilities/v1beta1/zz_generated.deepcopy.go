...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PolicySchemaSpec) DeepCopyInto(out *PolicySchemaSpec) {
	*out = *in
	if in.Description != nil {
		in, out := &in.Description, &out.Description
		*out = new([]string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PolicySchemaSpec.
func (in *PolicySchemaSpec) DeepCopy() *PolicySchemaSpec {
	if in == nil {
		return nil
	}
	out := new(PolicySchemaSpec)
	in.DeepCopyInto(out)
	return out
}
