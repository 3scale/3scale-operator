...
func (in *ApplicationAuthList) DeepCopyInto(out *ApplicationAuthList) {
	*out = *in
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]ApplicationAuth, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ApplicationAuthStatus) DeepCopy() *ApplicationAuthStatus {
	if in == nil {
		return nil
	}
	out := new(ApplicationAuthStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *BillingConfig) DeepCopyInto(out *BillingConfig) {
	*out = *in
	if in.BillAllTenants != nil {
		in, out := &in.BillAllTenants, &out.BillAllTenants
		*out = new(bool)
		**out = **in
	}
	if in.BillNow != nil {
		in, out := &in.BillNow, &out.BillNow
		*out = new(bool)
		**out = **in
	}
}
...
func (in *BillingSpec) DeepCopyInto(out *BillingSpec) {
	*out = *in
	if in.TenantAccountID != nil {
		in, out := &in.TenantAccountID, &out.TenantAccountID
		*out = new(int64)
		**out = **in
	}
	if in.DeveloperAccountID != nil {
		in, out := &in.DeveloperAccountID, &out.DeveloperAccountID
		*out = new(int64)
		**out = **in
	}
	if in.ProviderAccountRef != nil {
	...
	in.BillingConfig.DeepCopyInto(&out.BillingConfig)
}
...
func (in *BillingStatus) DeepCopyInto(out *BillingStatus) {
	*out = *in
	...
	if in.BillDate != nil {
		in, out := &in.BillDate, &out.BillDate
		*out = new(string)
		**out = **in
	}
	if in.Conditions != nil {
...
func (in *OIDCSpec) DeepCopyInto(out *OIDCSpec) {
	*out = *in
	if in.IssuerEndpointRef != nil {
		in, out := &in.IssuerEndpointRef, &out.IssuerEndpointRef
