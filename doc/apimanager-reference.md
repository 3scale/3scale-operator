...
| DisableApicastServiceReconciler | `disableApicastServiceReconciler` | bool | No | `false` | When false, 3scale API management solution will reconcile apicast services as normal. Setting this to true will stop 3scale from reconcilin apicast service ports                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
