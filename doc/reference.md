...
| WildcardPolicy | `wildcardPolicy` | string | No | `None` | Use `Subdomain` to create a wildcard route for apicast wildcard router |
...
| **Field** | **Description** | **Default value** |
| --- | --- | --- |
| URL | Shared secret to import events from backend to system. | `http://system-master:3000/master/events/import` |
