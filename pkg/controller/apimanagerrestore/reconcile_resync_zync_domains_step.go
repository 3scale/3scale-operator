...
type ReconcileResyncZyncDomainsStep struct {
	APIManagerRestoreBaseStep
}

func (r *ReconcileResyncZyncDomainsStep) Execute() (reconcile.Result, error) {
...
func (r *ReconcileResyncZyncDomainsStep) Completed() (bool, error) {
	desired := r.apiManagerRestore.ZyncResyncDomainsJob()
	if desired == nil {
...
func (r *ReconcileResyncZyncDomainsStep) Identifier() string {
	return "ReconcileResyncZyncDomainsStep"
}
