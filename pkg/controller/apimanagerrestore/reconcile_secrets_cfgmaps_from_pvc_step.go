...
type ReconcileSecretsAndCfgMapsFromPVCStep struct {
	APIManagerRestoreBaseStep
}

func (r *ReconcileSecretsAndCfgMapsFromPVCStep) Execute() (reconcile.Result, error) {
...
func (r *ReconcileSecretsAndCfgMapsFromPVCStep) Completed() (bool, error) {
	desired := r.apiManagerRestore.RestoreSecretsAndConfigMapsFromPVCJob()
	if desired == nil {
		return false, fmt.Errorf("Error obtaining desired object")
	}
...
func (r *ReconcileSecretsAndCfgMapsFromPVCStep) Identifier() string {
	return "ReconcileSecretsAndCfgMapsFromPVCStep"
}
