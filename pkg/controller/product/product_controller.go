...
var log = logf.Log.WithName("controller_product")
...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileProduct{client: mgr.GetClient(), scheme: mgr.GetScheme()}
}

// add adds a new Controller to mgr with r as the reconcile.Reconciler
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	// Create a new controller
	c, err := controller.New("product-controller", mgr, controller.Options{Reconciler: r})
	if err != nil {
		return err
	}
	...
	// Watch for changes to secondary resource Pods and requeue the owner Product
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &capabilitiesv1beta1.Product{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileProduct) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	reqLogger.Info("Reconciling Product")

	// Fetch the Product instance
	instance := &capabilitiesv1beta1.Product{}
	...
	// Set Product instance as the owner and controller
...
func newPodForCR(cr *capabilitiesv1beta1.Product) *corev1.Pod {
