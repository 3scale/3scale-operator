...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &capabilitiesv1beta1.Account{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &capabilitiesv1beta1.Account{},
	})
	if err != nil {
		return err
	}
...
// blank assignment to verify that ReconcileAccount implements reconcile.Reconciler
...
func (r *ReconcileAccount) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &capabilitiesv1beta1.Account{}
...
func newPodForCR(cr *capabilitiesv1beta1.Account) *corev1.Pod {
