...
// AccountProviderStatus defines the observed state of AccountProvider
...
// +kubebuilder:resource:path=accountproviders,scope=Namespaced
type AccountProvider struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   AccountProviderSpec   `json:"spec,omitempty"`
	Status AccountProviderStatus `json:"status,omitempty"`
}
