...
func (in *APIcastBaseSelectors) DeepCopyInto(out *APIcastBaseSelectors) {
	*out = *in
	if in.MappingRulesSelector != nil {
		in, out := &in.MappingRulesSelector, &out.MappingRulesSelector
		*out = new(v1.LabelSelector)
		(*in).DeepCopyInto(*out)
	}
	if in.PoliciesSelector != nil {
		in, out := &in.PoliciesSelector, &out.PoliciesSelector
		*out = new(v1.LabelSelector)
		(*in).DeepCopyInto(*out)
	}
	return
