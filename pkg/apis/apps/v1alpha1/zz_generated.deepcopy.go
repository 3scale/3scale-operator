...
func (in *APIManagerSpec) DeepCopyInto(out *APIManagerSpec) {
	*out = *in
	...
	if in.ApicastSpec != nil {
		in, out := &in.ApicastSpec, &out.ApicastSpec
		*out = new(ApicastSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.BackendSpec != nil {
		in, out := &in.BackendSpec, &out.BackendSpec
		*out = new(BackendSpec)
		(*in).DeepCopyInto(*out)
	}
	...
	if in.ZyncSpec != nil {
		in, out := &in.ZyncSpec, &out.ZyncSpec
		*out = new(ZyncSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.WildcardRouterSpec != nil {
		in, out := &in.WildcardRouterSpec, &out.WildcardRouterSpec
		*out = new(WildcardRouterSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.HighAvailabilitySpec != nil {
		in, out := &in.HighAvailabilitySpec, &out.HighAvailabilitySpec
