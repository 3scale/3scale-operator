...
func (backendRedis *BackendRedis) ConfigMap() *v1.ConfigMap {
	return &v1.ConfigMap{
		ObjectMeta: backendRedis.buildConfigMapObjectMeta(),
		TypeMeta:   backendRedis.buildConfigMapTypeMeta(),
		Data:       backendRedis.buildConfigMapData(),
	}
}

func (backendRedis *BackendRedis) buildConfigMapObjectMeta() metav1.ObjectMeta {
	return metav1.ObjectMeta{
		Name:   backendRedisConfigVolumeName,
		Labels: backendRedis.Options.RedisLabels,
	}
...
func (backendRedis *BackendRedis) buildConfigMapTypeMeta() metav1.TypeMeta {
	return metav1.TypeMeta{
		Kind:       "ConfigMap",
		APIVersion: "v1",
	}
...
func (backendRedis *BackendRedis) buildConfigMapData() map[string]string {
	return map[string]string{
		"redis.conf": backendRedis.getRedisConfData(),
	}
}

func (backendRedis *BackendRedis) getRedisConfData() string { // TODO read this from a real file
