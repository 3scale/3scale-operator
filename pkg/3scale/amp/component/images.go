...
func ApicastImageURL() string {
	return "registry.redhat.io/3scale-amp2/apicast-gateway-rhel7:3scale2.7"
}

func BackendImageURL() string {
	return "registry.redhat.io/3scale-amp2/backend-rhel7:3scale2.7"
}

func SystemImageURL() string {
	return "registry.redhat.io/3scale-amp2/system-rhel7:3scale2.7"
}

func ZyncImageURL() string {
	return "registry.redhat.io/3scale-amp2/zync-rhel7:3scale2.7"
}
...
func SystemMemcachedImageURL() string {
	return "registry.redhat.io/3scale-amp2/memcached-rhel7:3scale2.7"
}
