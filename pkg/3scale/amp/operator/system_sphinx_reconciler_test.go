...
func TestSystemSphinxReconciler(t *testing.T) {
	var (
	...
	reconciler := NewSystemSphinxReconciler(baseAPIManagerLogicReconciler)
	...
	cases := []struct {
		...
		{"PVC", component.SystemSphinxPVCName, &v1.PersistentVolumeClaim{}},
		{"Service", component.SystemSphinxServiceName, &v1.Service{}},
		{"DC", component.SystemSphinxDeploymentName, &appsv1.DeploymentConfig{}},
	}
