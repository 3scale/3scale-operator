...
func NewZyncOptionsProvider(apimanager *appsv1beta1.APIManager, namespace string, client client.Client) *ZyncOptionsProvider {
...
func (z *ZyncOptionsProvider) setSecretBasedOptions() error {
	...
	if z.apimanager.IsExternal(appsv1beta1.ZyncDatabase) {
		var err error
	...
	cases := []struct {
		...
		},
		{
			...
			z.apimanager.IsExternal(appsv1beta1.ZyncDatabase),
		},
	}
