...
func (h *HighAvailabilityOptionsProvider) setSystemDatabaseOptions() error {
	...
	if h.apimanager.IsSystemDatabaseTLSEnabled() {
		...
		requiredFields := []struct {
			...
			{&h.options.SystemDatabaseSslCa, component.SystemSecretDatabaseSslCa},
			{&h.options.SystemDatabaseSslCert, component.SystemSecretDatabaseSslCert},
			{&h.options.SystemDatabaseSslKey, component.SystemSecretDatabaseSslKey},
...
func defaultSystemDatatbaseSslCa() string {
	return ""
}

func defaultSystemDatatbaseSslCert() string {
	return ""
}
func defaultSystemDatatbaseSslKey() string {
	return ""
}

func defaultSystemDatatbaseSslMode() string {
	return ""
}

func defaultZyncDatatbaseSslCa() string {
	return ""
}

func defaultZyncDatatbaseSslCert() string {
	return ""
}
func defaultZyncDatatbaseSslKey() string {
	return ""
}

func defaultZyncDatatbaseSslMode() string {
	return ""
}
